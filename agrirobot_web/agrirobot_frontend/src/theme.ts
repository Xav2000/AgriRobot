...
const sharedTokens = {
  ...
  palette: {
    ...
    secondary: { main: '#FFC107', light: '#FFD54F', dark: '#FFA000', contrastText: '#000000' },
...
const componentOverrides = {
  ...
  MuiAppBar: { styleOverrides: { root: { boxShadow: '0 2px 8px rgba(0,0,0,0.1)' } } },
};
...
export const darkTheme = createTheme({
  ...
  palette: {
    ...
    text: { primary: '#EDEDED', secondary: '#AAAAAA' },
  },
  components: {
    ...componentOverrides,
    MuiCard: {
    ...
    MuiDialog: { styleOverrides: { paper: { backgroundImage: 'none', backgroundColor: '#2a2a2a' } } },
    MuiPopover: { styleOverrides: { paper: { backgroundImage: 'none', backgroundColor: '#2a2a2a' } } },
    MuiMenu: { styleOverrides: { paper: { backgroundImage: 'none', backgroundColor: '#2a2a2a' } } },
  },
});
